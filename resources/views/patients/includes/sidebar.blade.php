<div class="col-lg-4">
  <div class="panel panel-default text-center">
    ...
    <div class="panel-body">
      ...
      <big><address><b>Address :</b> <br>@if($user->description){{$user->description}}@else <span class="alert-danger">Please Add your Address</span>@endif</address></big>
  ...
  <div class="panel panel-default text-center">
    ...
    <div class="panel-body">
      <ul class="list-group">
        ...
        <a href="{{route('prescription.list',['id' => $user->patient_id])}}">
